...
# Fisco Exchange API Ver 1.00.00 対応版
# 2017/1/21現在
...
module Vexapion
	...
	# @see https://fcce.jp/api-docs/

	class Fisco < BaseExchanges
		
		#@api private
		def initialize(key = nil, secret = nil)
			super(key,secret)

			@public_url = 'https://api.fcce.jp/api/1/'
			@private_url = 'https://api.fcce.jp/tapi'
		end
